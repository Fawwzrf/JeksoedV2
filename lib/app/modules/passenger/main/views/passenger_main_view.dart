...
class PassengerMainView extends GetView<PassengerMainController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: _CustomPassengerNavBar(
...
// Custom Bottom Navigation mirip Compose
class _CustomPassengerNavBar extends StatelessWidget {
  final int currentIndex;
  final ValueChanged<int> onTap;
  _CustomPassengerNavBar({required this.currentIndex, required this.onTap});
    ...
    return Container(
      ...
      child: Row(
        ...
        children: List.generate(_items.length, (i) {
          return Expanded(
            child: Obx(() {
              final selected = i == Get.find<PassengerMainController>().currentIndex.value;
